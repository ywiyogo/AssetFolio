...
class MainFrame : public wxFrame
{
	...
	public:
		...
		MainFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Assetfolio - Your Portfolio Tracker That Keeps Assets Private"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 1100,800 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
